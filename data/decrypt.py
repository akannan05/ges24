...
input_file_path = './data/train.zip'  # Path to the input binary file
encrypted_file_path = './data/train.bin'  # Path to the output encrypted file
decrypted_file_path = './data/decrypted_file.zip'  # Path to the output decrypted file
